...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/login') }}"><b>InfyOm </b>Generator</a>
    </div>
    ...
    <div class="login-box-body">
        ...
        <a href="{{ url('/password/reset') }}">@lang('login.forgot_password')</a><br>
        <a href="{{ url('/register') }}" class="text-center">@lang('login.register_membership')</a>
